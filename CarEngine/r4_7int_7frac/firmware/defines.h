...
typedef ap_fixed<14,7> q_dense_47_quantized_relu_default_t;
typedef ap_fixed<14,7> layer11_t;
typedef ap_fixed<32,8> q_dense_47_quantized_relu_table_t;
typedef ap_fixed<14,7> q_dense_48_default_t;
...
typedef ap_fixed<14,7> add_32_default_t;
typedef ap_fixed<14,7> layer14_t;
typedef ap_fixed<14,7> add_33_default_t;
typedef ap_fixed<14,7> layer15_t;
typedef ap_fixed<22,10> q_multi_head_attention_17accum_t;
typedef ap_fixed<18,11> q_multi_head_attention_17table_t;
typedef ap_fixed<14,7> q_multi_head_attention_17_default_t;
typedef ap_fixed<14,7> layer16_t;
typedef ap_fixed<14,7> q_dense_49_default_t;
...
typedef ap_fixed<14,7> q_dense_49_quantized_relu_default_t;
typedef ap_fixed<14,7> layer18_t;
typedef ap_fixed<32,8> q_dense_49_quantized_relu_table_t;
typedef ap_fixed<14,7> q_dense_50_default_t;
...
typedef ap_fixed<14,7> add_34_default_t;
typedef ap_fixed<14,7> layer21_t;
typedef ap_fixed<14,7> add_35_default_t;
typedef ap_fixed<14,7> layer22_t;
typedef ap_fixed<14,7> model_default_t;
typedef ap_fixed<14,7> q_dense_51_default_t;
...
typedef ap_fixed<14,7> q_dense_51_quantized_relu_default_t;
typedef ap_fixed<14,7> layer25_t;
typedef ap_fixed<32,8> q_dense_51_quantized_relu_table_t;
typedef ap_fixed<14,7> q_dense_52_default_t;
...
typedef ap_fixed<14,7> q_dense_52_quantized_relu_default_t;
typedef ap_fixed<14,7> layer27_t;
typedef ap_fixed<32,8> q_dense_52_quantized_relu_table_t;
typedef ap_fixed<14,7> q_dense_53_default_t;
...
typedef ap_fixed<14,7> q_dense_53_quantized_softmax_default_t;
